...
const api = {
  ...
  getNavMapFeatures: async (input) => electron.ipcRenderer.invoke(IPC_CHANNELS.navMapFeatures, input),
  searchNavMapPoints: async (input) => electron.ipcRenderer.invoke(IPC_CHANNELS.navMapSearch, input),
  ...
  pickChartsDirectory: async () => electron.ipcRenderer.invoke(IPC_CHANNELS.storagePickChartsDirectory),
  importChartFromUrl: async (input) => electron.ipcRenderer.invoke(IPC_CHANNELS.chartImportFromUrl, input),
