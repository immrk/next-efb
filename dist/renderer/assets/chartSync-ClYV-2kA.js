import { z as getAppClient } from "./index-CvrMHZCP.js";
...
function notifyChartChanged() {
  window.dispatchEvent(new CustomEvent(CHART_CHANGED_EVENT));
}
function subscribeChartChanged(onChanged) {
...
export {
  __webpack_exports__getDocument as _,
  __webpack_exports__GlobalWorkerOptions as a,
  notifyChartChanged as n,
  subscribeChartChanged as s
};
